...
describe("Calendar - Microsoft E2E tests", () => {
  let calendarKey: ICommonRequestFields["calendarKey"] = "microsoftCalendar";
  let provider: ICommonRequestFields["provider"] = "microsoft";

  beforeEach("Create a Microsoft Calendar", function () {
